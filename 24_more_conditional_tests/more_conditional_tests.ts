...
console.log("Equality test with numbers:", (26 as number) == 24);
...
console.log("using or operator test:", ( 10 as number) === 9 || 10 < 10 );
// 
...
// test whether an item is not in  array test 16
